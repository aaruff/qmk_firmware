...
[_SYMBL] = LAYOUT(
  ...
  _______, _______, KC_QWERTY_WIN, _______, _______, _______,                         KC_QUOT, KC_LCBR, KC_RCBR, KC_PIPE, KC_BSLS, KC_MINS,
  _______, ALT_GUI_LEFT, _______, _______, ALT_GUI_RIGHT, _______,                         KC_MINUS, KC_LBRC, KC_RBRC, XXXXXXX, XXXXXXX, KC_UNDS,
