...
[_SYMBL] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______,                         _______, KC_LCBR, KC_RCBR, KC_PIPE, KC_BSLS, KC_MINUS,
  _______, _______, _______, _______, _______, _______,                         _______, KC_LBRC, KC_RBRC, KC_PLUS, CTL_SLSH, KC_EQL,
  _______, _______, _______, _______, _______, _______,XXXXXXX,XXXXXXX, _______, SC_LSPO, SC_RSPC, KC_COMM, KC_SCLN, _______,
